<template>
  <div class="group cursor-pointer rounded-md">
    <div
      class="grid h-full w-full grid-cols-1 grid-rows-1 overflow-visible rounded-2xl transition-transform md:group-hover:-translate-y-2 md:group-active:group-hover:-translate-y-1"
    >
      <!-- surface -->
      <div
      ...
      <!-- corner & edge slope -->
      <div
        class="z-10 col-start-1 row-start-1 hidden h-[calc(100%-0.75em)] w-[calc(100%-0.25em)] rounded-md bg-zinc-300 bg-opacity-60 transition-opacity md:flex md:group-hover:bg-opacity-80"
      />
      <!-- side -->
      <div
