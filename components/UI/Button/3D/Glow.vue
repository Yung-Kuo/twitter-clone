<template>
  <div class="group cursor-pointer rounded-md">
    ...
    >
      ...
      <!-- side -->
      <div
        class="col-start-1 row-start-1 hidden h-full w-full bg-zinc-500 transition-all md:flex md:rounded-[0.375em_0.65em_0.375em_0.75em/0.375em_1.125em_0.375em_1.125em] md:group-hover:bg-zinc-400 md:group-hover:bg-opacity-90 md:group-hover:shadow-lg md:group-hover:shadow-zinc-300 md:group-active:shadow-md md:group-active:shadow-zinc-300"
      ></div>
    </div>
  </div>
</template>
